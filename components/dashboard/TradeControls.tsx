    ...
    <Card className="p-4">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        ...
        >
          ...
          <option value="testnet-contract">testnet-contract mode (browser wallet)</option>
        </select>
      ...
      <div className="mt-4 grid gap-2 text-[11px] text-terminal-muted md:grid-cols-3">
        ...
        <div className="border border-terminal-border bg-terminal-panelAlt px-3 py-2">
          ...
          <br />
          Uses a deployed ledger on Arc testnet through explicit browser-wallet confirmation.
        </div>
      </div>
